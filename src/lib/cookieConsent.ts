// Cookie Consent logic for Astro example
// Adapted from qrati-connect-solid-example
                      ...
                      body: [
                        {
                          ...
                          description: 'Used to distinguish unique visitors and measure website traffic.',
                          expiration: '2 years',
                        },
                        {
                          name: '_gid',
                          domain: 'Google Analytics',
                          description: 'Used to identify user journey across 24-hour sessions.',
                          expiration: '24 hours',
                        },
                      ],
                    },
